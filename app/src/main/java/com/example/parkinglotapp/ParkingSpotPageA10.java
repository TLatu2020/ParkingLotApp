...
public class ParkingSpotPageA10 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA10");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A10 car button pushed");
