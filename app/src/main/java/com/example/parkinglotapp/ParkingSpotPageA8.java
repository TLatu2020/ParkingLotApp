...
public class ParkingSpotPageA8 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA8");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A8 car button pushed");
