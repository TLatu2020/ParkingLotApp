...
public class ParkingSpotPageA7 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA7");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A7 car button pushed");
