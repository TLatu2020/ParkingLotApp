...
public class ParkingSpotPageA15 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA15");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A15 car button pushed");
