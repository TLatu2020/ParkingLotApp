...
public class ParkingSpotPageA13 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA13");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A13 car button pushed");
