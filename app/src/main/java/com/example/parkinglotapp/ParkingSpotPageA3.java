...
public class ParkingSpotPageA3 extends AppCompatActivity {

    //This constant uses the name of the class itself as the tag
    private static final String LOG_TAG =
            ParkingSpotPage.class.getSimpleName();
    public static final String TAG = "A3 ParkingSpotData";

    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA3");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A3 car button pushed");
