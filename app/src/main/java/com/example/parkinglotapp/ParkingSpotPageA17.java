...
public class ParkingSpotPageA17 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA17");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A17 car button pushed");
