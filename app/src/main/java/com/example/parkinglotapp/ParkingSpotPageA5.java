...
public class ParkingSpotPageA5 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA5");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A5 car button pushed");
