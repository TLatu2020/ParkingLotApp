...
public class ParkingSpotPageA18 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA18");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A18 car button pushed");
