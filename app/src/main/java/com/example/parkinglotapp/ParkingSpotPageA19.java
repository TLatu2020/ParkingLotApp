...
public class ParkingSpotPageA19 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA19");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A19 car button pushed");
