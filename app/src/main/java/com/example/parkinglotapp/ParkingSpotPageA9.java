...
public class ParkingSpotPageA9 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA9");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A9 car button pushed");
