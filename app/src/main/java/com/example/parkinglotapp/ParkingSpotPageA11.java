...
public class ParkingSpotPageA11 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA11");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A11 car button pushed");
