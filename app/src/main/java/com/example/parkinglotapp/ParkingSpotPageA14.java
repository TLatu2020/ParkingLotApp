...
public class ParkingSpotPageA14 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA14");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A14 car button pushed");
