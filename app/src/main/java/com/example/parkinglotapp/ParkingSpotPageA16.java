...
public class ParkingSpotPageA16 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA16");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A16 car button pushed");
