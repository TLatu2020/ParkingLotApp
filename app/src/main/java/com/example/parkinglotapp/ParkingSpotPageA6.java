...
public class ParkingSpotPageA6 extends AppCompatActivity {
    ...
    private DocumentReference mDocRef = FirebaseFirestore.getInstance().collection("parkingLot").document("parkingSpaceA6");
    ...
    public void removeCar(View view){
        Log.i("INFO", "Remove A6 car button pushed");
